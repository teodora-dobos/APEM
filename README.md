...
- **Power flow models** (only for ``US_model``): `DCOPF`, `Zonal_NTC`, `Zonal_NTC_independent`, `Zonal_FBMC` (base cases: `BC1`, `BC2`, `BC3.1`, `BC3.2`, `BC4`)
...
- **Zonal configurations** (only for `US_model/Zonal_NTC`, `US_model/Zonal_NTC_independent` and `US_model/Zonal_FBMC`): `national`, `zonal_DE2-k`, `zonal_DE2-s`, `zonal_DE3`, `zonal_DE4`, `zonal_DE5`
