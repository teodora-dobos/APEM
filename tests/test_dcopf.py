...
class Test_DCOPF_IEEERTS_PricingAlgorithm(unittest.TestCase):
    ...
    def test_IEEE_RTS_DCOPF_IP(self):
        try:
            solve_scenario(US_Datasets.IEEE_RTS, PowerFlowModels.DCOPF.value, PricingAlgorithms.IP)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_IP: {e}")

    def test_IEEE_RTS_DCOPF_ELMP(self):
        try:
            solve_scenario(US_Datasets.IEEE_RTS, PowerFlowModels.DCOPF.value, PricingAlgorithms.ELMP)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_ELMP: {e}")

    def test_IEEE_RTS_DCOPF_Join(self):
        try:
            solve_scenario(US_Datasets.IEEE_RTS, PowerFlowModels.DCOPF.value, PricingAlgorithms.Join)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_Join: {e}")

    def test_IEEE_RTS_DCOPF_MinMWP(self):
        try:
            solve_scenario(US_Datasets.IEEE_RTS, PowerFlowModels.DCOPF.value, PricingAlgorithms.MinMWP)
        except Exception as e:
...
class Test_DCOPF_ARPA_PricingAlgorithm(unittest.TestCase):
    ...
    def test_ARPA_DCOPF_IP(self):
        try:
            solve_scenario(US_Datasets.ARPA, PowerFlowModels.DCOPF.value, PricingAlgorithms.IP)
        except Exception as e:
            self.fail(f"Exception raised in test_ARPA_DCOPF_IP: {e}")

    def test_ARPA_DCOPF_ELMP(self):
        try:
            solve_scenario(US_Datasets.ARPA, PowerFlowModels.DCOPF.value, PricingAlgorithms.ELMP)
        except Exception as e:
            self.fail(f"Exception raised in test_ARPA_DCOPF_ELMP: {e}")

    def test_ARPA_DCOPF_Join(self):
        try:
            solve_scenario(US_Datasets.ARPA, PowerFlowModels.DCOPF.value, PricingAlgorithms.Join)
        except Exception as e:
            self.fail(f"Exception raised in test_ARPA_DCOPF_Join: {e}")

    def test_ARPA_DCOPF_MinMWP(self):
        try:
            solve_scenario(US_Datasets.ARPA, PowerFlowModels.DCOPF.value, PricingAlgorithms.MinMWP)
        except Exception as e:
...
class Test_DCOPF_PyPSAEurSmall_PricingAlgorithm(unittest.TestCase):
    ...
    def test_PyPSAEurSmall_DCOPF_IP(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurSmall, PowerFlowModels.DCOPF.value, PricingAlgorithms.IP)
        except Exception as e:
            self.fail(f"Exception raised in test_PyPSAEurSmall_DCOPF_IP: {e}")

    def test_PyPSAEurSmall_DCOPF_ELMP(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurSmall, PowerFlowModels.DCOPF.value, PricingAlgorithms.ELMP)
        except Exception as e:
            self.fail(f"Exception raised in test_PyPSAEurSmall_DCOPF_ELMP: {e}")

    def test_PyPSAEurSmall_DCOPF_Join(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurSmall, PowerFlowModels.DCOPF.value, PricingAlgorithms.Join)
        except Exception as e:
            self.fail(f"Exception raised in test_PyPSAEurSmall_DCOPF_Join: {e}")

    def test_PyPSAEurSmall_DCOPF_MinMWP(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurSmall, PowerFlowModels.DCOPF.value, PricingAlgorithms.MinMWP)
        except Exception as e:
...
class Test_DCOPF_PyPSAEurLarge_PricingAlgorithm(unittest.TestCase):
    ...
    def test_PyPSAEurLarge_DCOPF_IP(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurLarge, PowerFlowModels.DCOPF.value, PricingAlgorithms.IP)
        except Exception as e:
            self.fail(f"Exception raised in test_PyPSAEurLarge_DCOPF_IP: {e}")

    def test_PyPSAEurLarge_DCOPF_ELMP(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurLarge, PowerFlowModels.DCOPF.value, PricingAlgorithms.ELMP)
        except Exception as e:
            self.fail(f"Exception raised in test_PyPSAEurLarge_DCOPF_ELMP: {e}")

    def test_PyPSAEurLarge_DCOPF_Join(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurLarge, PowerFlowModels.DCOPF.value, PricingAlgorithms.Join)
        except Exception as e:
            self.fail(f"Exception raised in test_PyPSAEurLarge_DCOPF_Join: {e}")

    def test_PyPSAEurLarge_DCOPF_MinMWP(self):
        try:
            solve_scenario(US_Datasets.PyPSAEurLarge, PowerFlowModels.DCOPF.value, PricingAlgorithms.MinMWP)
        except Exception as e:
...
class Test_DCOPF_PJM_PricingAlgorithm(unittest.TestCase):
    ...
    def test_PJM_DCOPF_IP(self):
        try:
            solve_scenario(US_Datasets.PJM, PowerFlowModels.DCOPF.value, PricingAlgorithms.IP)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_IP: {e}")

    def test_PJM_DCOPF_ELMP(self):
        try:
            solve_scenario(US_Datasets.PJM, PowerFlowModels.DCOPF.value, PricingAlgorithms.ELMP)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_ELMP: {e}")

    def test_PJM_DCOPF_Join(self):
        try:
            solve_scenario(US_Datasets.PJM, PowerFlowModels.DCOPF.value, PricingAlgorithms.Join)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_Join: {e}")

    def test_PJM_DCOPF_MinMWP(self):
        try:
            solve_scenario(US_Datasets.PJM, PowerFlowModels.DCOPF.value, PricingAlgorithms.MinMWP)
        except Exception as e:
            self.fail(f"Exception raised in test_IEEE_RTS_DCOPF_MinMWP: {e}")
